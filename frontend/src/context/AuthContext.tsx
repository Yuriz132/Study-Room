...
interface AuthContextValue {
  ...
  register: (username: string, password: string, extra?: { hp?: string; email?: string; phone?: string; geetest?: { lot_number: string; captcha_output: string; pass_token: string; gen_time: string } }) => Promise<void>
